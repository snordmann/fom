  ...
  for (var i = 0, iLen = iomnames.length; i < iLen; i +=1) {
    global[iomnames[i]] = (function () {
      var dummySite = "dummy",
          ...
          cookieName = "ioam2018",
          cookieMaxRuns = 0,
          socioToken = "345fd771d477884ef89b522b3db10592",
      ...
      function buildResult(params) {
        ...
        result.lo = "DE/Bremen";
        result.cb = "001b";
        result.i2 = "001b2509c4093902e5fd771d4";
        result.ep = parseInt('1635547968', 10);
        result.vr = "418";
      ...
      processConsent('', {vendors: consentVendors, cookie: consentCookieOptions, resultKey: 'ct' }, result);
      return {
        count: count,
        c: count,
        i: init,
