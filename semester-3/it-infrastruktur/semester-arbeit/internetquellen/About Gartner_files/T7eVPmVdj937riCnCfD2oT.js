var vidyard_player_width_T7eVPmVdj937riCnCfD2oT = 640;
var vidyard_player_height_T7eVPmVdj937riCnCfD2oT = 360;
var vidyard_html5_T7eVPmVdj937riCnCfD2oT = false;
var vidyard_secure_T7eVPmVdj937riCnCfD2oT = false;
var vidyard_integration_check_T7eVPmVdj937riCnCfD2oT = function() {};
var vidyard_T7eVPmVdj937riCnCfD2oT_params = {};
var vidyard_T7eVPmVdj937riCnCfD2oT_raw_params = '';
...
(function() {
  ...
  var embed_script = document.getElementById('vidyard_embed_code_T7eVPmVdj937riCnCfD2oT');
  var playerDetails = {"keywords":"Gartner","thumbnailUrl":"https://play.vidyard.com/T7eVPmVdj937riCnCfD2oT.jpg","@context":"http://schema.org/","@type":"VideoObject","id":"T7eVPmVdj937riCnCfD2oT","description":"Gartner equips executives across the enterprise to make the right decisions and stay ahead of change.\r\n\r\nFounded in 1979, we are the leading research and advisory company. We’ve expanded well beyond our flagship technology research to provide senior leaders across the enterprise with the indispensable business insights, advice and tools they need to achieve their mission-critical priorities and build the organizations of tomorrow.\r\n\r\nTogether with our clients, we fuel the future of business so that a more successful world takes shape.\r\n\r\nLearn more about us in this brief video or read on.","name":"About Gartner - Clients and Gartner - Fueling the Future of Business","transcript":"The future doesn't invent itself.\nIt's created by today's business leaders\nwho know that the pace of change will never\nbe this slow again.\nAt Gartner, we work with these\nleaders every day\nas they pursue their mission-critical priorities,\nseize opportunity from disruption,\ncast a vision for the future\nand build it\nstep-by-step.\nWe equip them with indispensable insight\nadvice\nand tools\nto confidently tackle today's challenges\nand pursue tomorrow's possibilities.\nTogether,\nwe fuel the future of business.\nAnd a more successful world takes shape.\n","uploadDate":"2019-03-29T16:24:01.000Z","duration":"T0M56S","embedUrl":"https://play.vidyard.com/T7eVPmVdj937riCnCfD2oT","height":360,"width":640};
  ...
  function check_for_duplicate_embeds() {
    ...
    for (var i = 0; i < all_scripts.length; ++i) {
      if (all_scripts[i].getAttribute('id') === "vidyard_embed_code_T7eVPmVdj937riCnCfD2oT") {
    ...
    if (dupe_scripts.length >= 1) {
      ...
      if (typeof document.querySelectorAll === 'function') {
        ...
        for (var i = 0; i < wrappers.length; ++i) {
          if (wrappers[i].getAttributeNode('onclick').value === "fn_vidyard_T7eVPmVdj937riCnCfD2oT();") {
  ...
  if (!embed_script || !embed_script.src) {
    ...
    for (var i in scripts) {
      ...
      if (script.src && /^.+(vidyard\.com).*\/T7eVPmVdj937riCnCfD2oT.*/.test(script.src)) {
        embed_script = script;
        break;
      }
    }
  ...
  if (embed_script && embed_script.src) {
    ...
    vidyard_T7eVPmVdj937riCnCfD2oT_raw_params = rawQueryParams;
    ...
    embed_script.src.replace(/(?:[\?&])([^&=]*)=?([^&#]*)/g, function ($0, $1, $2) {
      if ($1) {
        switch ($1) {
          ...
          case 'vylegacy':
            vidyard_T7eVPmVdj937riCnCfD2oT_params[$1] = (parseInt($2, 10) !== 0);
            break;
          case 'chapter':
            vidyard_T7eVPmVdj937riCnCfD2oT_params[$1] = parseInt($2, 10);
            break;
          case 'width':
          ...
          case 'height':
            ...
            break;
          case 'X-VY-Signature':
            vidyard_secure_T7eVPmVdj937riCnCfD2oT = true;
          default:
            vidyard_T7eVPmVdj937riCnCfD2oT_params[$1] = $2;
            break;
        }
      }
    });
  ...
  if (!vidyard_T7eVPmVdj937riCnCfD2oT_params.type || vidyard_T7eVPmVdj937riCnCfD2oT_params.type !== 'lightbox') {
    vidyard_T7eVPmVdj937riCnCfD2oT_params.type = 'inline';
  }

  // Determine Player Settings which effect embed
  var multi_chapter = false && !(typeof vidyard_T7eVPmVdj937riCnCfD2oT_params.hide_html5_playlist !== 'undefined' && vidyard_T7eVPmVdj937riCnCfD2oT_params.hide_html5_playlist);
  var playlist_always_open = false;
  if (typeof vidyard_T7eVPmVdj937riCnCfD2oT_params.playlist_always_open !== 'undefined') {
    playlist_always_open = vidyard_T7eVPmVdj937riCnCfD2oT_params.playlist_always_open;
  }
  ...
  if (query_player_width && query_player_width > 0 && query_player_height && query_player_height > 0) {
    vidyard_player_width_T7eVPmVdj937riCnCfD2oT = query_player_width;
    vidyard_player_height_T7eVPmVdj937riCnCfD2oT = query_player_height;
  } else if (query_player_width && query_player_width > 0) {
    query_player_height = (query_player_width * vidyard_player_height_T7eVPmVdj937riCnCfD2oT) / vidyard_player_width_T7eVPmVdj937riCnCfD2oT;
    vidyard_player_width_T7eVPmVdj937riCnCfD2oT = query_player_width;
    vidyard_player_height_T7eVPmVdj937riCnCfD2oT = query_player_height;
  } else if (query_player_height && query_player_height > 0) {
    query_player_width = (query_player_height * vidyard_player_width_T7eVPmVdj937riCnCfD2oT) / vidyard_player_height_T7eVPmVdj937riCnCfD2oT;
    vidyard_player_width_T7eVPmVdj937riCnCfD2oT = query_player_width;
    vidyard_player_height_T7eVPmVdj937riCnCfD2oT = query_player_height;
  }

  var iframe_container = document.getElementById("vidyard_T7eVPmVdj937riCnCfD2oT");
  ...
  if (!iframe_container && vidyard_T7eVPmVdj937riCnCfD2oT_params.type === 'inline') {
    iframe_container = document.createElement("span");
    iframe_container.id = 'vidyard_T7eVPmVdj937riCnCfD2oT';
  ...
  if (vidyard_secure_T7eVPmVdj937riCnCfD2oT === false) {
    // Get cookie data/ids from various MAPs/CRMs
    var pardot_id = fn_getCookie("pardot");
    if (pardot_id) {
      vidyard_T7eVPmVdj937riCnCfD2oT_params.pardot_id = pardot_id;
    }

    var hubspot_id = fn_getCookie("hubspotutk");
    if (hubspot_id) {
      vidyard_T7eVPmVdj937riCnCfD2oT_params.hubspot_id = hubspot_id;
    }
    ...
    if (marketo_id && munchkin_id && marketo_id.toLowerCase().indexOf(munchkin_id) > -1) {
      vidyard_T7eVPmVdj937riCnCfD2oT_params.marketo_id = encodeURIComponent(marketo_id);
    }

    var dreamforce_id = fn_getCookie("vy_dreamforce");
    if (dreamforce_id) {
      vidyard_T7eVPmVdj937riCnCfD2oT_params.dreamforce_id = encodeURIComponent(dreamforce_id);
    }
    ...
    if (vycustom_id !== "") {
      vidyard_T7eVPmVdj937riCnCfD2oT_params.custom_id = vycustom_id;
    }

    // Gets the vyemail query string param, which connects views to an email entered
    var vyemail = get_parameter_by_name('vyemail');
    if (vyemail !== "") {
      vidyard_T7eVPmVdj937riCnCfD2oT_params.email = vyemail;
    }

    var vyac = get_parameter_by_name('vyac');
    var vyplayer = get_parameter_by_name('vyplayer');
    if (vyplayer === 'T7eVPmVdj937riCnCfD2oT') {
      vidyard_T7eVPmVdj937riCnCfD2oT_params.access_code = vyac;
    }
  }
  ...
  if (navigator.userAgent.toLowerCase().match(/ip(ad|od|hone)|android/)) {
    vidyard_html5_T7eVPmVdj937riCnCfD2oT = true;
    vidyard_T7eVPmVdj937riCnCfD2oT_params.disable_popouts = true;
  }
  ...
  function create_embed() {
    ...
    var integration_tracking_check = function() {
      if (playerReady) {
        ...
        window.addEventListener('message', function callback(e) {
          ...
          if (data.event === "ready" && data.uuid === "T7eVPmVdj937riCnCfD2oT") {
    ...
    var integration_tracking_check_original = function () {
      ...
      if (!referringUrlSent && vidyard_secure_T7eVPmVdj937riCnCfD2oT === true && vidyard_T7eVPmVdj937riCnCfD2oT_params.referring_url) {
        var playerFrame = Vidyard.Helpers.getPlayerIFrame('T7eVPmVdj937riCnCfD2oT');
        var message = {
          'event': 'parentReferer',
          'uuid': 'T7eVPmVdj937riCnCfD2oT',
          'data': {
            'value': vidyard_T7eVPmVdj937riCnCfD2oT_params.referring_url
          }
        }
      ...
      if (!vidyard_T7eVPmVdj937riCnCfD2oT_params.pardot_id) {
        var pardot_id = fn_getCookie("pardot");
        if (pardot_id) {
          vidyard_T7eVPmVdj937riCnCfD2oT_params.pardot_id = pardot_id;
      ...
      if (!vidyard_T7eVPmVdj937riCnCfD2oT_params.hubspot_id) {
        var hubspot_id = fn_getCookie("hubspotutk");
        if (hubspot_id) {
          vidyard_T7eVPmVdj937riCnCfD2oT_params.hubspot_id = hubspot_id;
      ...
      if (!vidyard_T7eVPmVdj937riCnCfD2oT_params.dreamforce_id) {
        var dreamforce_id = fn_getCookie("vy_dreamforce");
        if (dreamforce_id) {
          dreamforce_id = encodeURIComponent(dreamforce_id);
          vidyard_T7eVPmVdj937riCnCfD2oT_params.dreamforce_id = dreamforce_id;
          messages.push({'data': {'type': 'dreamforce', 'value': dreamforce_id}});
        }
      }
      if (!vidyard_T7eVPmVdj937riCnCfD2oT_params.marketo_id) {
        var marketo_id = fn_getCookie("_mkto_trk");
        var munchkin_id = '';
        
        if (marketo_id && munchkin_id && marketo_id.toLowerCase().indexOf(munchkin_id) > -1) {
          marketo_id = encodeURIComponent(marketo_id);
          vidyard_T7eVPmVdj937riCnCfD2oT_params.marketo_id = marketo_id;
        ...
        if (!eloquaSent &&
            vidyard_T7eVPmVdj937riCnCfD2oT_params.eloqua_id &&
            ((vidyard_secure_T7eVPmVdj937riCnCfD2oT === true && vidyard_T7eVPmVdj937riCnCfD2oT_params.type === 'lightbox') ||
             (vidyard_T7eVPmVdj937riCnCfD2oT_params.type === 'inline'))) {
          eloquaSent = true;
          messages.push({'data': {'type': 'eloqua', 'value': vidyard_T7eVPmVdj937riCnCfD2oT_params.eloqua_id}});
        }
      

      // inline embeds are ready to receive api requests
      // lightbox will pass data through querystring params
      if (vidyard_T7eVPmVdj937riCnCfD2oT_params.type === "inline" || vidyard_secure_T7eVPmVdj937riCnCfD2oT === true) {
        for(var i in messages) {
          messages[i].event = 'associateVisitor';
          messages[i].uuid = 'T7eVPmVdj937riCnCfD2oT';
          Vidyard.Helpers.getPlayerIFrame('T7eVPmVdj937riCnCfD2oT').contentWindow.postMessage(JSON.stringify(messages[i]), window.location.protocol + '//play.vidyard.com');
        }
      }
    ...
    vidyard_integration_check_T7eVPmVdj937riCnCfD2oT = integration_tracking_check;

    // Display the inline or lightbox
    if (vidyard_T7eVPmVdj937riCnCfD2oT_params.type === "inline") {
      // Load the iframe
      iframe_container.innerHTML = fn_vidyard_build_iframe_T7eVPmVdj937riCnCfD2oT(false, vidyard_player_width_T7eVPmVdj937riCnCfD2oT, vidyard_player_height_T7eVPmVdj937riCnCfD2oT);

      Vidyard.Helpers.addListener(
        'load',
        'onload',
        function() {
          fn_vidyard_iframe_after_load_T7eVPmVdj937riCnCfD2oT();
          integration_tracking_check();
        },
        Vidyard.Helpers.getPlayerIFrame('T7eVPmVdj937riCnCfD2oT')
      );

    } else if (vidyard_T7eVPmVdj937riCnCfD2oT_params.type === "lightbox") {
      ...
      if (document.readyState === 'complete') {
        if (!vidyard_secure_T7eVPmVdj937riCnCfD2oT) {
          integration_tracking_check();
        }
    ...
    function getEloquaCookie() {
      if (timerId !== null) {
        ...
        if (typeof this.GetElqCustomerGUID === 'function') {
          ...
          vidyard_T7eVPmVdj937riCnCfD2oT_params.eloqua_id = eloqua_id;
          return;
        } else if (this._elqQ) {
  ...
  Vidyard._players['T7eVPmVdj937riCnCfD2oT'] = '';
}());
  ...
  (function () {
    function async_load() {
      ...
      _elqQ.push(['elqSetSiteId', 1849907385]);
...
var vyContactCallback = function(data) {
  ...
  vidyard_T7eVPmVdj937riCnCfD2oT_params.marketo_lead = marketoData;
  ...
  // or tried again after IFrame loads in fn_vidyard_iframe_after_load_T7eVPmVdj937riCnCfD2oT
  playerIframe = Vidyard.Helpers.getPlayerIFrame('T7eVPmVdj937riCnCfD2oT');
  if ( playerIframe ) {
    message = {'data': {'type': 'marketo', 'value': marketoData}};
    message.event = 'identifyVisitor';
    message.uuid = 'T7eVPmVdj937riCnCfD2oT';
...
(function () {
  function async_load() {
    var contactId = vidyard_T7eVPmVdj937riCnCfD2oT_params.marketo_id;
    if (!contactId) {
    ...
    var url = window.location.protocol + '//play.vidyard.com'
        + '/v3/T7eVPmVdj937riCnCfD2oT/contact/' + encodeURIComponent(contactId) + '/marketoContact.js';
...
function fn_vidyard_build_iframe_T7eVPmVdj937riCnCfD2oT(lightbox, iframe_width, iframe_height) {
  if (lightbox) {
    vidyard_T7eVPmVdj937riCnCfD2oT_params.autoplay = true;
  }

  var referring_url = encodeURIComponent(document.referrer);
  if (referring_url) {
    vidyard_T7eVPmVdj937riCnCfD2oT_params.referring_url = referring_url;
  }
  ...
  if (document.documentMode === 7) {
    ...
    var ie7RepaintIframe = function() {
      var iframe = Vidyard.Helpers.getPlayerIFrame('T7eVPmVdj937riCnCfD2oT');
  ...
  if (vidyard_secure_T7eVPmVdj937riCnCfD2oT === true) {
    query_params_string = vidyard_T7eVPmVdj937riCnCfD2oT_raw_params;
  } else {
    for (var param in vidyard_T7eVPmVdj937riCnCfD2oT_params) {
      var param_value = vidyard_T7eVPmVdj937riCnCfD2oT_params[param];
      if (param_value === true) {
        param_value = '1';
      }
  ...
  return '<span id="vidyard_span_T7eVPmVdj937riCnCfD2oT" style="display: block; margin: auto; position: relative; width: ' + iframe_width + 'px; height: ' + iframe_height + 'px;"><iframe id="vidyard_iframe_T7eVPmVdj937riCnCfD2oT" class="vidyard_iframe" src="//play.vidyard.com/T7eVPmVdj937riCnCfD2oT?' + query_params_string + '" width="' + iframe_resizer + '" height="100%" title="Video" aria-label="Video" scrolling=no frameborder=0 allowtransparency="true" allowfullscreen allow="autoplay" referrerpolicy="no-referrer-when-downgrade" style="opacity: 0; background-color: transparent; position: absolute; ' + ios_width_fix + ' right: 0px; top: 0px;"></iframe></span>';
}

// --- If the browser is FF, reload the iframe with the given id
function fn_vidyard_iframe_after_load_T7eVPmVdj937riCnCfD2oT() {
  var _theframe = Vidyard.Helpers.getPlayerIFrame('T7eVPmVdj937riCnCfD2oT');
  if (_theframe) {
    ...
    if (vidyard_secure_T7eVPmVdj937riCnCfD2oT === true && vidyard_T7eVPmVdj937riCnCfD2oT_params.type === 'lightbox') {
      vidyard_integration_check_T7eVPmVdj937riCnCfD2oT();
    }
    ...
    if (vidyard_T7eVPmVdj937riCnCfD2oT_params.marketo_lead) {
      var message = {'data': {'type': 'marketo', 'value': vidyard_T7eVPmVdj937riCnCfD2oT_params.marketo_lead }};
      message.event = 'identifyVisitor';
      message.uuid = 'T7eVPmVdj937riCnCfD2oT';
      Vidyard.Helpers.getPlayerIFrame('T7eVPmVdj937riCnCfD2oT')
...
function fn_vidyard_T7eVPmVdj937riCnCfD2oT() {
  var vidyard = {};
    ...
    return {
      show:function(initial_iframe_settings) {
        var showCore = function () {
          ...
          var width_height = this.lock_to_aspect_ratio(iframe_settings.width, iframe_settings.height, (319 + (vidyard_player_width_T7eVPmVdj937riCnCfD2oT / 5)));
      ...
      fill_iframe: function(settings_html_url, has_element, use_post_request, should_animate, width, height) {
        if(has_element) {
          if(iframe_settings.image) {
            ...
            this.set_tinner_size(fn_vidyard_build_iframe_T7eVPmVdj937riCnCfD2oT(true, width, height), should_animate, width, height);
          } else {
      ...
      resize: function() {
        ...
        var width_height = v_box.lock_to_aspect_ratio(
            vidyard_player_width_T7eVPmVdj937riCnCfD2oT,
            vidyard_player_height_T7eVPmVdj937riCnCfD2oT,
            319 + (vidyard_player_width_T7eVPmVdj937riCnCfD2oT / 5)
        );

        iframe_settings.width = width_height[0];
        iframe_settings.height = width_height[1];

        var vidyard_iframe = Vidyard.Helpers.getPlayerIFrame('T7eVPmVdj937riCnCfD2oT');
        var vidyard_span = document.getElementById('vidyard_span_T7eVPmVdj937riCnCfD2oT');
      ...
      fade_element: function(element_to_fade, fading_in, target_alpha) {
        ...
        if (old_opacity == target_alpha) {
          ...
          if (fading_in == -1) {
            ...
            Vidyard.Helpers.getPlayerIFrame('T7eVPmVdj937riCnCfD2oT').src = '';
  ...
  vidyard.box.show({
    iframe: '#', width: vidyard_player_width_T7eVPmVdj937riCnCfD2oT,
    height: vidyard_player_height_T7eVPmVdj937riCnCfD2oT,
    animate: !vidyard_html5_T7eVPmVdj937riCnCfD2oT,
    fixed: true
  });
}
